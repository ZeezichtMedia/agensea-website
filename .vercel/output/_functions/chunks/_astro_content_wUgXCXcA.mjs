...
import { d as renderElement, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, e as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, f as createHeadAndContent, c as renderComponent } from './entrypoint_COwXl-An.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_TAiHfnEc.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_heeYVJUQ.mjs').then(n => n._);
