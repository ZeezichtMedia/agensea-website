...
import { d as renderElement, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, e as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, f as createHeadAndContent, c as renderComponent } from './entrypoint_CIqzDYY3.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CcLJmauH.mjs').then(n => n._);
